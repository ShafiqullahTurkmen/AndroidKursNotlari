package com.yemeksahibi.tarifler.Database;
...
import com.yemeksahibi.tarifler.BuildConfig;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "Yemeksahibi.db";
    ...
    public String getCategoryName(int id){
        ...
        try{
            ...
            Cursor c = db.rawQuery("select * from offline_Categories where id="+id,null);
            while (c.moveToNext()){
                str = c.getString(1);
            }
        }catch (Exception e){
    ...
    public Cursor getSelectedReturn(String query){
        myDatabase = this.getReadableDatabase();
